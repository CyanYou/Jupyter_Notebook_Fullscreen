define([
    ...
    function load_ipython_extension() {
        var handler = function () {
            $('.cell.code_cell.selected').each(function() {
                ...
                if (outputArea.length) {
                    toggleFullscreen(outputArea[0]); // fullscreen the output area
                    outputArea.css({'background-color': 'white'}); // optionally set background color
                }
            });
        };
        ...
        var action = {
            ...
            help: 'expand cell output to fullscreen', // mouseover text
            help_index: 'zz',
            handler: handler
        };
